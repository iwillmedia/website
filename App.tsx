                ...
                <div key={partner.name} className="px-4 py-3 text-center">
                  {partner.src ? (
                    <img
                      ...
                      className={`h-14 sm:h-16 md:h-10 w-auto object-contain ${partner.invert ? 'invert' : ''} ${partner.name === 'OpenAI' ? 'scale-90' : ''} ${partner.name === 'Claude' ? 'brightness-150' : ''} ${partner.name === 'Copilot' ? 'brightness-150' : ''}`}
                    />
                  ) : (
                    partner.name
                  )}
