        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              { label: '', title: 'AI BOTS', sub: 'QUIET OPS', icon: Bot, offset: '-mt-2', desc: 'AI Bots sit on the front line of your business, handling direct interactions with customers and prospects. They answer calls, respond to messages, capture details, book appointments, and follow up automatically — 24/7. These bots are trained on your business rules, tone, and processes, so they behave like a competent team member, not a script. Their job is simple: ensure nothing is missed. AI Bots reduce pressure on human staff while improving response times and customer experience. They work quietly, but their impact is immediate.' },
              { label: '', title: 'AI AUTOMATION', sub: 'ARCHITECTURE', icon: Settings, offset: '', desc: 'AI Automation connects systems, tools, and workflows so work moves without human intervention. We design automations that link phones, inboxes, calendars, CRMs, and internal tools into a single operating flow. This removes repetitive tasks, manual copying, and process delays that slow teams down. Automation isn’t about replacing judgment — it’s about removing unnecessary effort. When done properly, it becomes invisible infrastructure that keeps the business running smoothly. This is where scale becomes sustainable.' },
            ].map((card) => (
              <button
                key={card.title}
                type="button"
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            {[
              ...
              { label: 'Help Center & FAQs', href: '/help.html' },
            ].map((item) => (
              <a
                key={item.label}
                href={item.href}
